import com.megapolis.FacebookService
...
//
//    facebookService(FacebookService) { bean ->
//        bean.scope = 'session'
//    }
//
//    facebookServiceProxy(org.springframework.aop.scope.ScopedProxyFactoryBean) {
//        targetBeanName = 'facebookService'
